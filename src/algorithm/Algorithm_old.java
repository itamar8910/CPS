...
public class Algorithm_old{
	 ...
	 */
	public Algorithm_old(JSONArray state, int spotsInRow){ // CONSTRUCTOR
	...
	Algorithm_old(int numSpotsInRow){ // 2nd CONSTRUCTOR
		int i, j, t;
	...
	Algorithm_old(int numSpotsInRow, Spot[][][] parkArray){ // 3rd CONSTRUCTOR
...
//						DBString += Long.toString(this.park[i][j][k].getExitTime()) + ",";
	...
	public static void main(String args[]) {
		try {
			...
			Algorithm_old alg = new Algorithm_old(start, 4);
